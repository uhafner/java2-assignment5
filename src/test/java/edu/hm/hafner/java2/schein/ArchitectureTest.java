...
import edu.hm.hafner.java2.schein.ArchitectureTest.DoNotIncludeArchitectureTest;
...
@AnalyzeClasses(packages = "edu.hm.hafner.java2", importOptions = DoNotIncludeArchitectureTest.class)
class ArchitectureTest {
    ...
    static final class DoNotIncludeArchitectureTest implements ImportOption {
        @Override
        public boolean includes(final Location location) {
            return !location.contains(ArchitectureTest.class.getSimpleName());
        }
    }
}
